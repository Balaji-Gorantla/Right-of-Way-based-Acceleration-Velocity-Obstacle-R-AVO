function L = Admis_Velocity(obj,time) 
...
vel_x =linspace(-v_max,v_max,7);% + obj.Position(1);
vel_y =linspace(-v_max,v_max,7);% + obj.Position(2);
...
v_goal = [cos(theta_goal), sin(theta_goal)];
